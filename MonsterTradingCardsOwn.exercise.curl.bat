...
REM --------------------------------------------------
echo 20) own commands: add card to deck that is not mine
echo should fail: user tries to add card to deck that doesn't belong to them (forbidden)
curl -i -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer kienboec-mtcgToken" -d "[\"aa9999a0-734c-49c6-8f4a-651864b14e62\", \"99f8f8dc-e25e-4a95-aa2c-782823f36e2a\", \"e85e3976-7c86-4d06-9a80-641c2019a79f\", \"171f6076-4eb5-4a7d-b3f2-2d650cc3d237\"]"
echo should fail: user has no Deck to battle with (no content)
